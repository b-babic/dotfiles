...
-- Typescript (ts_ls) ======================================================
lspconfig.ts_ls.setup({ on_attach = on_attach_custom, single_file_support = true })

-- Stimulus (solargraph) ======================================================
lspconfig.stimulus_ls.setup({ on_attach = on_attach_custom })

-- Ruby (solargraph) ==========================================================
lspconfig.solargraph.setup({ on_attach = on_attach_custom, filetypes = { 'ruby', 'eruby' } })

-- Tailwind CSS (tailwindcss) =================================================
lspconfig.tailwindcss.setup({ on_attach = on_attach_custom })

-- Emmet (emmet_ls) ===========================================================
lspconfig.emmet_ls.setup({ on_attach = on_attach_custom })

-- HTML (html) ================================================================
lspconfig.html.setup({ on_attach = on_attach_custom, filetypes = { 'html', 'eruby' } })

-- CSS (cssls) ================================================================
lspconfig.cssls.setup({ on_attach = on_attach_custom })

-- Stylelint (stylelint_lsp) ==================================================
lspconfig.stylelint_lsp.setup({ on_attach = on_attach_custom })

-- JSON (jsonls) ==============================================================
lspconfig.jsonls.setup({ on_attach = on_attach_custom })

-- YAML (yamlls) ==============================================================
lspconfig.yamlls.setup({ on_attach = on_attach_custom })

-- Dockerfile (dockerls) ======================================================
lspconfig.dockerls.setup({ on_attach = on_attach_custom })

-- Docker compose (dockerls) ==================================================
lspconfig.docker_compose_language_service.setup({ on_attach = on_attach_custom })

-- Bash (bashls) ==============================================================
lspconfig.bashls.setup({ on_attach = on_attach_custom })

-- SQL (sqls) =================================================================
lspconfig.sqls.setup({ on_attach = on_attach_custom })
