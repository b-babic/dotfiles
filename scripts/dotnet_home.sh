...
version=`mise current dotnet-core | awk '{print $1}'`

echo "Parsed version: $version"

export DOTNET_MSBUILD_SDK_RESOLVER_SDKS_DIR=$(echo $HOME/.local/share/mise/installs/dotnet-core/$version/sdk/$version/Sdks)
export DOTNET_MSBUILD_SDK_RESOLVER_SDKS_VER=$version
export DOTNET_MSBUILD_SDK_RESOLVER_CLI_DIR=$(echo $HOME/.local/share/mise/installs/dotnet-core/$version)
#
